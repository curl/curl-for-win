...
set _BAS=%_NAM%-%VER_LIBSSH2%-%CPU%-mingw
...
curl -fsS -u "%BINTRAY_USER%:%BINTRAY_APIKEY%" -X PUT "https://api.bintray.com/content/%BINTRAY_USER%/generic/%_NAM%%_REPOSUFF%/%VER_LIBSSH2%/%_BAS%.zip?override=1&publish=1" --data-binary "@%_BAS%.zip"
