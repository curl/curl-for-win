...
(
  ...
  for pass in static; do  # FIXME: 'shared' broken.
    ...
    export CPPFLAGS='-DHAVE_ATOMIC -DNDEBUG -DHAVE_SOCKET -DHAVE_IOCTLSOCKET_FIONBIO -DHAVE_FREEADDRINFO -DHAVE_GETADDRINFO -DHAVE_GETADDRINFO_THREADSAFE -DHAVE_PROCESS_H -DHAVE_CLOSESOCKET -DHAVE_STRUCT_POLLFD -DHAVE_GETPEERNAME -DHAVE_GETSOCKNAME'
    export LIBS=''
    ldonly=''
