...
# Automated, reproducible, transparent, Windows builds for [cURL](http://curl.haxx.se), [nghttp2](https://nghttp2.org), [libssh2](https://github.com/libssh2/libssh2), [OpenSSL](https://www.openssl.org)
