...
(
  ...
  export CURL_CFLAG_EXTRAS='-fno-ident -DCURL_STATICLIB -DHAVE_ATOMIC -DNDEBUG -DHAVE_STRTOK_R -DUSE_HEADERS_API -DHAVE_BOOL_T -DHAVE_STDBOOL_H -DHAVE_STRING_H -DHAVE_SETJMP_H -DHAVE_FTRUNCATE -D_FILE_OFFSET_BITS=64 -DSIZEOF_OFF_T=8'
