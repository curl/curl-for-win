...
(
  ...
  options="${options} -DENABLE_APP=0"
  options="${options} -DENABLE_HPACK_TOOLS=0"
  options="${options} -DENABLE_ASIO_LIB=0"
  options="${options} -DENABLE_EXAMPLES=0"
  options="${options} -DENABLE_PYTHON_BINDINGS=0"
