...
if [ "${test}" = 'test.exe' ]; then
  if command -v x86_64-w64-mingw32-gcc >/dev/null 2>&1; then
    ...
    #   curl https://raw.githubusercontent.com/ayaka14732/TinyPE-on-Win10/84674cc255dcb1616f4ea426fa64204df618c4b7/step9/stretch.exe \
    #   | openssl base64 -e > test.exe.b64
    #   # SHA2-256: 28ccee525da46662a1e9af42238b984abac65625cb5677efee5fe3a793ba7ecd
    #   # SHA2-512: aac8f74ae62cd63c9394ab07d8d30a32c2977807561ccdce214810abadf4659fb2120127e2cb342a1748b220318b66000fc13dc4883a204bf56a418135646c90
    #   # length: 268 bytes
    cat << EOF | openssl base64 -d > "${test}"

EOF
