...
export NGHTTP2_VER_='1.14.1'
export NGHTTP2_HASH=f2208e3947f998baf8eaebe8de55c67cdef06426fd1f85599d50aae9ee98fa34
...
if [ "${_BRANCH#*libressl*}" != "${_BRANCH}" ] ; then
   # libressl
   curl -o pack.bin "https://www.mirrorservice.org/pub/OpenBSD/LibreSSL/libressl-${LIBRESSL_VER_}.tar.gz" || exit 1
   curl -o pack.sig "https://www.mirrorservice.org/pub/OpenBSD/LibreSSL/libressl-${LIBRESSL_VER_}.tar.gz.asc" || exit 1
